...
public class Flink_watermark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Student2> student2DataStream = studentDataStreamSource.assignTimestampsAndWatermarks(new AssignerWithPeriodicWatermarks<Student2>() {
